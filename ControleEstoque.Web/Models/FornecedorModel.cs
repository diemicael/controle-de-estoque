        ...
        public int Salvar()
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                conexao.Open();
                    ...
                    if (model == null)
                    {
                        var sql = "insert into fornecedor (nome, razao_social, num_documento, tipo, telefone, contato, logradouro," +
                    ...
                    {
                        var sql = "update fornecedor set nome=@nome, razao_social=@razao_social, num_documento=@num_documento," +
