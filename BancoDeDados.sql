...
CREATE TABLE [dbo].[despesa] (
	...
	[internet] [decimal](7, 2) NOT NULL,
	[aluguel] [decimal](7, 2) NOT NULL,
	[seguranca] [decimal](7, 2) NOT NULL,
	[telefone] [decimal](7, 2) NOT NULL,
	[marketing] [decimal](7, 2) NOT NULL,
	[salarios] [decimal](7, 2),
	[total] [decimal](7, 2),
...
GO
ALTER TABLE [dbo].[funcionario] WITH CHECK ADD FOREIGN KEY([id_pais]) REFERENCES [dbo].[pais] ([id])
GO
ALTER TABLE [dbo].[funcionario] WITH CHECK ADD FOREIGN KEY([id_estado]) REFERENCES [dbo].[estado] ([id])
GO
ALTER TABLE [dbo].[funcionario] WITH CHECK ADD FOREIGN KEY([id_cidade]) REFERENCES [dbo].[cidade] ([id])
GO
